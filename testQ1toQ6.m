...
for i=1:len
    ...
    if keypoint(i,3) == 4
        plot(keypoint(i,1)*16,keypoint(i,2)*16,  'mo', 'LineWidth', 2, 'MarkerSize', 42);
    end  
%     if keypoint(i,3) == 5
%         plot(keypoint(i,1)*32,keypoint(i,2)*32,  'ro', 'LineWidth', 2, 'MarkerSize', 52);
%     end   
    hold on
end
pause(2)
...
for ind_histogram =1:size(arr_histogram,2)
